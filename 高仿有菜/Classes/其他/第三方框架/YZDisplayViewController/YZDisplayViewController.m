...
- (UIColor *)norColor
{
    if (_norColor == nil) self.norColor = [UIColor darkGrayColor];
...
- (UIColor *)selColor
{
    if (_selColor == nil) self.selColor = [UIColor colorWithRed:10/255.0 green:178/255.0 blue:10/255.0 alpha:1.0]
;
...
- (void)setUpTitleGradient:(void(^)(YZTitleColorGradientStyle *titleColorGradientStyle,UIColor **norColor,UIColor **selColor))titleGradientBlock;
{
    ...
    if (titleGradientBlock) {
        ...
        if (selColor) {
            self.selColor = [UIColor colorWithRed:10/255.0 green:178/255.0 blue:10/255.0 alpha:1.0]
;
        }
    }
...
- (void)setUpUnderLineEffect:(void(^)(BOOL *isUnderLineDelayScroll,CGFloat *underLineH,UIColor **underLineColor,BOOL *isUnderLineEqualTitleWidth))underLineBlock
{
    ...
    _isUnderLineEqualTitleWidth = false;
    ...
    if (underLineBlock) {
        ...
        _underLineColor = [UIColor colorWithRed:10/255.0 green:178/255.0 blue:10/255.0 alpha:1.0];
    }
